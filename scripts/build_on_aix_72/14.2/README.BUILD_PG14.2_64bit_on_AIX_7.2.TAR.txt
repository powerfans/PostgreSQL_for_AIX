...
###Download PostgreSQL source from https://ftp.postgresql.org/pub/source/v14.2/postgresql-14.2.tar.gz
# cd /home; gzip -d postgresql-14.2.tar.gz; 
# tar xf postgresql-14.2.tar; cd /home/postgresql-14.2

### Adjust Makefile to avoid Undefined symbol issue
# cd /home/postgresql-14.2/src
...
LDFLAGS_SL="-Wl,-G" \
./configure \
    --prefix=/opt/postgres/14.2 \
    --libdir=/opt/postgres/14.2/lib64 \
...
# cd /opt/postgres
# tar cf postgresql14-server-14.2-1PGDG.aix.7.2.tar ./14.2; gzip *.tar
