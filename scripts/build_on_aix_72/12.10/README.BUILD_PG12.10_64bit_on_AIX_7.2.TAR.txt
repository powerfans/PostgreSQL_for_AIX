...
###Download PostgreSQL source from https://ftp.postgresql.org/pub/source/v12.10/postgresql-12.10.tar.gz
# cd /home; gzip -d postgresql-12.10.tar.gz; 
# tar xf postgresql-12.10.tar; cd /home/postgresql-12.10

### Adjust Makefile to avoid Undefined symbol issue
# cd /home/postgresql-12.10/src
...
LDFLAGS_SL="-Wl,-G" \
./configure \
    --prefix=/opt/postgres/12.10 \
    --libdir=/opt/postgres/12.10/lib64 \
...
# cd /opt/postgres
# tar cf postgresql12-server-12.10-1PGDG.aix.7.2.tar ./12.10; gzip *.tar
