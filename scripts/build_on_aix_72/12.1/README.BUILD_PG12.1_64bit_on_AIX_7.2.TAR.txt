...
###Download PostgreSQL source from https://ftp.postgresql.org/pub/source/v12.1/postgresql-12.1.tar.gz
# cd /home; gzip -d postgresql-12.1.tar.gz; 
# tar xf postgresql-12.1.tar; cd /home/postgresql-12.1

### Adjust Mafile to avoid Undefined symbol issue
# cd /home/postgresql-12.1/src
...
# cd /home/postgresql-12.1/src/interfaces/libpq
...
LDFLAGS_SL="-Wl,-G" \
./configure \
    --prefix=/opt/postgres/12.1.1 \
    --libdir=/opt/postgres/12.1.1/lib64 \
...
# cd /opt/postgres
# tar cf postgresql12-server-12.1-1PGDG.aix.7.2.tar ./12.1; gzip *.tar
